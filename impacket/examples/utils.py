...
def ldap_login(target, base_dn, kdc_ip, kdc_host, do_kerberos, username, password, domain, lmhash, nthash, aeskey, ldaps_flag=False, target_domain=None, fqdn=False, encType=None, tgtOptions=None, tgsOptions=None):
    ...
    try:
        ...
        if do_kerberos is not True:
            ...
            ldapConnection.kerberosLogin(username, password, domain, lmhash, nthash, aeskey, kdcHost=kdc_ip, encType=encType, tgtOptions=tgtOptions, tgsOptions=tgsOptions)
